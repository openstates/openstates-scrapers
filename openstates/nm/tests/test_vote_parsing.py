...
class TestVoteParsing(object):
    ...
    def test_senate_parsing(self):
        ...
        voteKey = {'2017_vote_senate.pdf':
                   {'other_count': 1, '_type': 'vote', 'chamber': 'upper', 'yes_count': 39,
                    'yes_votes': ['CANDELARIA', 'PINTO', 'LOPEZ', 'SOULES', 'BACA',
                                  'ORTIZ y PINO', 'INGLE', 'SAPIEN', 'CERVANTES', 'PIRTLE',
                                  u'MUQOZ', 'WHITE', 'MARTINEZ', 'STEFANICS', 'PADILLA',
                                  'NEVILLE', 'WIRTH', 'IVEY-SOTO', 'SHARER', 'CISNEROS',
                                  'RODRIGUEZ', 'McSORLEY', 'STEINBORN', 'BURT', 'PAPEN',
                                  'KERNAN', 'SHENDO', "O'NEILL", 'GOULD', 'RUE', 'STEWART',
                                  'CAMPOS', 'PAYNE', 'LEAVELL', 'SMITH', 'GRIGGS', 'SANCHEZ',
                                  'MORALES', 'TALLMAN'],
                    'other_votes': ['MOORES'],
                    ...
                    'type': 'other',
                    'no_count': 2, 'no_votes': ['BRANDT', 'WOODS']
                    }
                   }
        ...
        for pdf in pdfs:
            ...
            if pdf in voteKey:
                eq_(vote, voteKey[pdf], '%s Vote results did not match up with redefined key' %
                    pdf)
    ...
    def test_house_parsing(self):
        ...
        voteKey = {'2017_vote_senate.pdf':
                   {'other_count': 1,
                    ...
                    'yes_votes': ['CANDELARIA', 'PINTO', 'LOPEZ', 'SOULES', 'BACA',
                                  'ORTIZ y PINO', 'INGLE', 'SAPIEN', 'CERVANTES', 'PIRTLE',
                                  u'MU\xd1OZ', 'WHITE', 'MARTINEZ', 'STEFANICS', 'PADILLA',
                                  'NEVILLE', 'WIRTH', 'IVEY-SOTO', 'SHARER',
                                  'CISNEROS', 'RODRIGUEZ', 'McSORLEY', 'STEINBORN', 'BURT',
                                  'PAPEN', 'KERNAN', 'SHENDO', "O'NEILL", 'GOULD', 'RUE',
                                  'STEWART', 'CAMPOS', 'PAYNE', 'LEAVELL', 'SMITH', 'GRIGGS',
                                  'SANCHEZ', 'MORALES', 'TALLMAN'],
                    'other_votes': ['MOORES'],
                    'motion': 'senate passage',
                    'sources': [{'url': '2017_vote_senate.pdf'}],
                    'date': datetime.datetime(2017, 1, 18, 0, 0),
                    'type': 'other', 'no_count': 2, 'no_votes': ['BRANDT', 'WOODS'],
                    'passed': True
                    }
                   }
        testData = os.path.join(here, 'testData')
