...
class VTLegislationScraper(LegislationScraper):
    ...
    metadata = {
        ...
        'session_details': {
            '1987-1988': {'years': [1987, 1988], 'election_year': 1986,
                          'sub_sessions': []},
            '1989-1990': {'years': [1989, 1990], 'election_year': 1988,
                          'sub_sessions': []},
            '1991-1992': {'years': [1991, 1992], 'election_year': 1990,
                          'sub_sessions': []},
            '1993-1994': {'years': [1993, 1994], 'election_year': 1992,
                          'sub_sessions': []},
            '1995-1996': {'years': [1995, 1996], 'election_year': 1994,
                          'sub_sessions': []},
            '1997-1998': {'years': [1997, 1998], 'election_year': 1996,
                          'sub_sessions': []},
            '1999-2000': {'years': [1999, 2000], 'election_year': 1998,
                          'sub_sessions': []},
            '2001-2002': {'years': [2001, 2003], 'election_year': 2000,
                          'sub_sessions': []},
            '2003-2004': {'years': [2003, 2004], 'election_year': 2002,
                          'sub_sessions': []},
            '2005-2006': {'years': [2005, 2006], 'election_year': 2004,
                          'sub_sessions': []},
            '2007-2008': {'years': [2007, 2008], 'election_year': 2006,
                          'sub_sessions': []},
            '2009-2010': {'years': [2009, 2010], 'election_year': 2008,
                          'sub_sessions': []},
            }
        }
