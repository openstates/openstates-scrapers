...
class LegislationScraper(object):
    ...
    def save_bill(self, bill):
        """
        Save a scraped :class:`utils.legislation.Bill` object. Only
    ...
    def save_person(self, person):
        """
        Save a scraped :class:`utils.legislation.Person` object. Only
        call after all data for the given person has been collected.

        Should be used for non-legislator people (e.g. Governor, Lt. Gov).
        To add :class:`utils.legislation.Legislator` objects call
        :meth:`utils.legislation.save_legislator`.
        """
    ...
    def save_legislator(self, legislator):
        """
        Save a scraped :class:`utils.legislation.Legislator` object.
    ...
    def save_committee(self, committee):
        """
        Save a scraped :class:`utils.legislation.Committee` object.
...
class Bill(FiftystatesObject):
    ...
    def add_vote(self, vote):
        """
        Associate a :class:`utils.legislation.Vote` object with this bill.
        """
...
class Person(FiftystatesObject):
    ...
    def __init__(self, full_name, **kwargs):
        ...
        Note: the :class:`utils.legislation.Legislator` class should
