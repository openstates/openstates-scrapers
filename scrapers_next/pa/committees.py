...
class HouseCommitteeDetail(HtmlPage):
    ...
    def process_page(self):
        com = self.input
        try:
            Chair_Member1 = CSS("div div div.MemberInfoList-MemberWrapper.ChairWrapper div.ChairNameText a").match(self.root)[0].text.strip()
            Chair_Member_rolez_1 = CSS("div div div.MemberInfoList-MemberWrapper.ChairWrapper div.ChairNameText div").match(self.root)[0].text.strip()
            com.add_member(Chair_Member1, Chair_Member_rolez_1)
            Chair_Member2 =CSS("div div div.MemberInfoList-MemberWrapper.ChairWrapper div.ChairNameText a").match(
                self.root)[1].text.strip()
            Chair_Member_rolez_2 = CSS("div div div.MemberInfoList-MemberWrapper.ChairWrapper div.ChairNameText div").match(
                self.root)[1].text.strip()
            com.add_member(Chair_Member2, Chair_Member_rolez_2)
        except IndexError:
            pass
        Members = XPath("/html/body/div/section/div/div[12]/div/div/div/div[2]").match(self.root)
        for mem in Members:
            try:
        ...
        Members_2 = XPath("/html/body/div/section/div/div[14]/div/div/div/div[2]").match(self.root)
...
class SenateCommitteeDetail(HtmlPage):
    ...
    def process_page(self):
        ...
        try:
            ...
            pass
        Members = XPath("/html/body/div/section/div/div[10]/div/div/div/div[2]").match(self.root)
        for mem in Members:
            try:
                member_name = XPath("div[1]/a").match_one(mem).text.strip()
                mem_position = XPath("div[2]").match_one(mem).text.strip()
                ...
                mem_position = "Member"
            com.add_member(member_name, mem_position)
        Members_2 = XPath("/html/body/div/section/div/div[12]/div/div/div/div[2]").match(self.root)
        for mem in Members_2:
            try:
                member_name2 = XPath("div[1]/a").match_one(mem).text.strip()
                mem_position2 = XPath("div[2]").match_one(mem).text.strip()
