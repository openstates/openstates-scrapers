...
_categorizer_rules = (
    ...
    Rule(['Amendment #\\d+ \\((?P<legislator>.+?)\\) pending'],
         ['amendment-introduction']),
    Rule(['Enacted'], ['passage']),
    Rule(['Amendment #\\S+ \\((?P<legislator>.+?)\\) Adopted',
    ...
    Rule(['Amendment #\\d+ \\((?P<legislator>.+?)\\) adopted'],
         ['amendment-passage']),
    ...
    Rule(['(?i)(Referred|Recommittedra) to (?P<committees>committee on.+)'],
         ['referral-committee']),
    Rule(['Accompanied a new draft, (see )?(?P<bill_id>[SH]\\S+)'], []),
    Rule(['(?i)Amendment #\\S+ \\((?P<legislator>.+?)\\) bundle NO rejected'],
         ['amendment-failure']),
    Rule(['(?i)(Referred|Recommittedra) to (?P<chamber>\\S+) (?P<committees>committee on.+)'],
         ['referral-committee']),
    Rule(['Committee recommended ought NOT'], ['committee-passage-unfavorable']),
    Rule(['(?i)(Referred|Recommittedra) (to|from)( the)? (?P<chamber>\\S+) '
