...
_categorizer_rules = (
    ...
    Rule(r"Introduced and Referred to Committee", ["introduction", "referral-committee"]),
    ...
    Rule(r"Item passed notwithstanding objections of the Governor", ["veto-override-passage"]),
