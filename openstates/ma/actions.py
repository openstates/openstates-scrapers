...
_categorizer_rules = (
    ...
    Rule([u'Discharged to the committee on (?P<committee>.+)'],
    ...
    Rule([u'Amendment #\\S+ \\((?P<legislator>.+?)\\) Rejected'],
         [u'amendment:failed']),
    Rule([u'referred to (?P<committee>.+)'], []),
    ...
    Rule([u'(?i)(Referred|Recommittedra) to (?P<committee>committee on.+)'],
         [u'committee:referred']),
    Rule([u'Accompanied a new draft, (see )?(?P<bill_id>[SH]\\S+)'], []),
    Rule([u'(?i)Amendment #\\S+ \\((?P<legislator>.+?)\\) bundle NO rejected'],
         [u'amendment:failed']),
    Rule([u'(?i)(Referred|Recommittedra) to (?P<chamber>\\S+) (?P<committee>committee on.+)'],
         [u'committee:referred']),
    Rule(['Committee recommended ought NOT'], ['committee:passed:unfavorable']),
    Rule([u'(?i)(Referred|Recommittedra) (to|from)( the)? (?P<chamber>\\S+) (?P<committee>committee on.+)'],
         [u'committee:referred']),
    Rule([u'(?i)Amendment #\\d+ rejected'], [u'amendment:failed']),
    Rule([u'(?i)Amendment \\d+ adopted'], [u'amendment:passed']),
